...
usage_pca_vars <- c('MOU','DIRECTAS','OVERAGE','ROAM','CHANGEM','DROPVCE','BLCKVCE','UNANSVCE','THREEWAY','MOUREC','OUTCALLS','INCALLS','PEAKVCE','OPEAKVCE','DROPBLK','CALLFWDV','CALLWAIT','DROPVCE','DROPBLK','BLCKVCE')
...
usage_tidied_pca %>%
  filter(component %in% paste0("PC", 2:5)) %>%
